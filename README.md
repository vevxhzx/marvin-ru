...
## Шесть вещей, ради которых это стоит поставить
...
| 💼 **Заказы (фриланс)** | `заказ: ролик для Пятёрочки, 25к, до пятницы` · `пришёл аванс 10к за ролик` · `таймер на ролик` · `цель: подушка 300к к марту` | дедлайн в календаре, ожидаемая оплата в прогнозе кассы, помодоро на сайте/в Telegram/голосом → ставка в час, конверты-цели, 50/30/20, «на сколько хватит» |
...
| 🎙 **Голос и компьютер** | «Марвин, открой браузер» · «найди файл договор» · «что на экране» · «разбери рабочий стол» | слово-активация офлайн, распознавание Whisper, озвучка; файлы **никогда не удаляются** |
...
- Этого бота я делаю лично для себя в основном, сам тестирую все и внедряю в свою жизнь
- Ясен пень таких джарвисов и крутых личных ассистентов которые полы за тебя моют тут миллиарды, я не претендую на второй openclaw или стать b2b saas p2p 2b2t txt стартапом, поэтому чисто такая свойская житейская сборочка ассистента
- Вопрос безопасности в этом боте стоит одним из важных, вроде и кому нужна информация что я по утрам ем колбасу, но все равно на общий доступ всю свою life выставлять не хочется, поэтому тут уже описано насчет безопасности, провожу всякие аудиты стараюсь закрывать дыры если они появляются...
- По опыту прикольная тема, оч помогает в треке заказов и просто представлении общей картины по финансам и жизни, чуть дает разгрузить голову в огромном инфопотоке
- Приветствую всякие добавления и фичи которые мб кто-то придумал, буду рад любой обратной связи
- Можно сказать это такое нишевое хоббэ, делать такую штуку так что да....
...
Стек: Python 3.11+ · FastAPI · SQLite · aiogram 3 · Ollama · faster-whisper · Vosk · Silero / edge-tts · React + Vite + Tailwind. Лицензия — [PolyForm Noncommercial 1.0.0](LICENSE): свободно для личного и некоммерческого использования, изменения и форки приветствуются; коммерческое использование — по договорённости с автором. Нашли ошибку — [issue](../../issues/new/choose); pull request'ы приветствуются, особенно новые фразы-шаблоны в `core/brain/quick.py` с тестами.

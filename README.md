...
Стек: Python 3.11+ · FastAPI · SQLite · aiogram 3 · Ollama · faster-whisper · Vosk · Silero / edge-tts · React + Vite + Tailwind. Лицензия — [Apache 2.0](LICENSE): берите, меняйте, используйте где угодно — но сохраняйте авторство (файл [NOTICE](NOTICE) и ссылку на этот репозиторий) и помечайте, что именно изменили. Нашли ошибку — [issue](../../issues/new/choose); pull request'ы приветствуются, особенно новые фразы-шаблоны в `core/brain/quick.py` с тестами.
